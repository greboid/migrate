...
import (
	...
	dStub "github.com/greboid/migrate/v4/database/stub"
	"github.com/greboid/migrate/v4/source"
	sStub "github.com/greboid/migrate/v4/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/greboid/migrate/v4/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/greboid/migrate/v4/source/stub"`
